...
class HistroyBookingsScreen extends StatelessWidget {
  HistroyBookingsScreen({super.key});
      ...
      body: bookings.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ReservationCardDitail(
                  hotailName: booking['hotelName'],
                  hotailImage: booking['image'],
                  hotailoction: booking['location'],
